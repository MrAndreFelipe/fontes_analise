...
class TextToSQLService:
    ...
    def generate_and_execute(self, question: str, constraints: Optional[str] = None, limit: int = 10) -> Dict[str, Any]:
        """
        Fluxo completo: Pergunta -> SQL -> Validação -> Execução -> Resultado
        """
        schema_text = self.introspector.get_schema_for_llm()
        sql = self.generator.generate_sql(question, schema_text, constraints)
